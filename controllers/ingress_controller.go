...
Some guides used to create this operator.
...
Most of the code here is generated by operator-sdk.
...
// operator-sdk added this, probblay to generate the rbac files.
...
//Reconcile function is running each time watched object is changed and the predicate functions didn't ignore it.
...
func (r *IngressReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		...
		// Filter events before triggering the reconcile function.
